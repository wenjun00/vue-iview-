  ...
  <section class="component modify-role">
    <i-form ref="form" :model="model" :label-width="110" :rules="rules">
      <i-form-item label="角色名称" prop="roleName">
        <i-input v-model="model.roleName" :maxlength="50"></i-input>
      </i-form-item>
      <i-form-item label="所属部门" prop="deptNames">
        <Cascader :data="orgTreeData" :render-format="format" v-model="model.deptNames" change-on-select @on-change="onChange" :disabled="!!roleData"></Cascader>
      </i-form-item>
