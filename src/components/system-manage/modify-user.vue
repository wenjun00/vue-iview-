...
<template>
  <section class="component modify-user">
    <i-form :label-width="140" class="modify-user-form" :model="model" ref="modify-user" inline :rules="rules">
      <i-form-item label="用户名" prop="userName">
        <i-input :maxlength="20" v-model="model.userName" :readonly="!orgId"></i-input>
      </i-form-item>
      <i-form-item label="姓名" prop="realName">
        <i-input :maxlength="10" v-model="model.realName"></i-input>
      </i-form-item>
      <i-form-item label="手机号" prop="phone">
        <i-input v-model="model.phone" :maxlength="11"></i-input>
      </i-form-item>
      <i-form-item label="邮箱" prop="email">
        <i-input :maxlength="30" v-model="model.email"></i-input>
      </i-form-item>
