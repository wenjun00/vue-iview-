...
<template>
  <section class="component deduct-record draw-record">
    <i-row class="form-row">
      ...
      <i-date-picker type="date" :options="$common.datePickDisabledDate()"  class="form-picker" placeholder="终止日期"></i-date-picker>
      <span class="form-periods">期数：</span>
      <i-input class="form-input" placeholder="请输入证件号码" :maxlength="18"></i-input>
