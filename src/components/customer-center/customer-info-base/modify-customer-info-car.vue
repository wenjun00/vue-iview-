  ...
  <section class="component modify-customer-info-car">
    <i-form ref="form" inline :model="model" :rules="rules" :label-width="110">
      ...
      <i-form-item label="车牌号" prop="carNo">
        <i-input v-model="model.carNo" clearable :maxlength="20"></i-input>
      </i-form-item>
      <i-form-item label="购车价格" prop="carPrice">
        <i-input-number v-model="model.carPrice" :min="0" :max="99999999" :formatter="$filter.moneyFormat" :parser="$filter.moneyParse" clearable></i-input-number>
      </i-form-item>
      ...
      <i-form-item label="抵押登记次数" prop="mortgageNum">
        <i-input-number v-model="model.mortgageNum" :min="0" :max="9999" clearable></i-input-number>
      </i-form-item>
      <i-form-item label="车架号" prop="stockCarNo">
        <i-input v-model="model.stockCarNo" :maxlength="17" clearable></i-input>
      </i-form-item>
    </i-form>
  </section>
</template>
