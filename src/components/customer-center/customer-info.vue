...
const CUSTOMER_BASE_COMPONENT = [
  ...
  { id: 2, pid: 0, title: "房产信息", component: "CustomerInfoHouse" },
  ...
  { id: 7, pid: 0, title: "意向记录", component: "CustomerInfoIntentionRecord" },
...
export default class CustomerInfo extends Vue {
  ...
  get customerGroupTreeData() {
    let treeData =  this.$common.generateTreeData(CUSTOMER_BASE_COMPONENT) as Array<any>
