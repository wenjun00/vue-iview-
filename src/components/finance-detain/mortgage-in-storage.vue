...
<template>
  <section class="component mortgage-in-storage">
    <i-form :label-width="90" style="margin-top:20px;" :model="model" :rules="rules" ref="form">
      <i-row :gutter="15">
        <i-col :span="12">
          <i-form-item label="GPS设备号" prop="gpsNo" width = "150px">
            <i-input v-model="model.gpsNo" :maxlength="50"></i-input>
          </i-form-item>
        </i-col>
        <i-col :span="12">
      ...
      <i-row :gutter="15">
        <i-col :span="12">
          <i-form-item label="入库日期" prop="stockDate">
            <i-date-picker type="date" :options="$common.datePickDisabledDate()"  placeholder="选择入库日期" v-model="model.stockDate"></i-date-picker>
          </i-form-item>
        </i-col>
      </i-row>
    </i-form>
