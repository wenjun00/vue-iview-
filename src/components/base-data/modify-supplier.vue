...
<template>
  <section class="component modify-supplier">
    <i-form ref="form" :model="model" :label-width="140" :rules="rules">
      <i-form-item label="名称" prop="supplierName">
        <i-input v-model="model.supplierName" clearable :maxlength="50"></i-input>
      </i-form-item>
      <i-form-item label="电话" prop="supplierPhone">
        <i-input v-model="model.supplierPhone" clearable :maxlength="11"></i-input>
      </i-form-item>
      <i-form-item label="地址" prop="supplierAddress">
        <i-input type="textarea" v-model="model.supplierAddress" clearable :maxlength="50"></i-input>
      </i-form-item>
...
export default class ModifySupplier extends Vue {
  ...
  private rules = {
    ...
    supplierPhone: { validator: this.$validator.phoneNumber, trigger: "blur" }
  };
