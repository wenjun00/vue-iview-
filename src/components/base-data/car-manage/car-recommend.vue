  ...
  <section class="component car-recommend">
    <i-form :model="model" :rules="rules" ref="form" :label-width="110">
      <i-form-item label="栏目名称" prop="name">
        <i-input v-model="model.name" placeholder="请输入栏目名称" :maxlength="50"></i-input>
      </i-form-item>
      ...
      <i-form-item label="栏目介绍" prop="comment">
        <i-input type="textarea" v-model="model.comment" placeholder="请输入栏目的介绍信息" :row="2" :maxlength="100"></i-input>
      </i-form-item>
    </i-form>
  </section>
</template>
