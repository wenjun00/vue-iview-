  ...
  <section class="component modify-basic-stock-car">
    <i-form :label-width="120" :model="model" :rules="rules" ref="form" inline>
      ...
      <i-form-item label="发动机号" prop="stockEngineNo">
        <i-input v-model="model.stockEngineNo" placeholder="请输入发动机号" :maxlength="8"></i-input>
      </i-form-item>
      <i-form-item label="车辆颜色" prop="stockCarColor">
        <i-input :maxlength="50" v-model="model.stockCarColor" placeholder="请输入车辆颜色"></i-input>
      </i-form-item>
      <i-form-item label="采购价格" prop="stockPrice">
        <i-input-number v-model="model.stockPrice" :min="0" :max="99999999" placeholder="请输入采购价格" :formatter="$filter.moneyFormat" :parser="$filter.moneyParse">
        </i-input-number>
      </i-form-item>
      <i-form-item label="备注" prop="remark">
        <i-input type="textarea" v-model="model.remark" placeholder="请输入备注" :maxlength="100"></i-input>
      </i-form-item>
    </i-form>
  </section>
</template>
