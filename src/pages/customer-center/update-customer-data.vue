<template>
  <section class="page update-customer-data">
    <page-header title="补填资料" hidden-print hidden-export>
    </page-header>
...
export default class FormalCustomer extends Page {
            ...
            h("i-button",
              {
                ...
                directives: this.$common.bindAuth(607),
                style: {
                  color: "#265EA2"
                },
                on: {
   ...
   */
  private refreshData() {
    this.basicCustomerCenterService.findCustomerList(this.model, this.pageService)
      .subscribe(
