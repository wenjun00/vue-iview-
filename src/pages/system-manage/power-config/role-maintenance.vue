...
<template>
  <section class="page role-maintenance">
    <page-header title="角色维护" hidden-print hidden-export>
      <command-button label="新增角色" @click="roleOperate()" v-auth="561"></command-button>
    </page-header>
    <data-form hidden-date-search :model="model" @on-search="searchRolesByAuth">
      <template slot="input">
        <i-form-item prop="roleName" label="角色名称：">
          <i-input placeholder="请输入角色名称" v-model="model.roleName" :maxlength="50"></i-input>
        </i-form-item>
  ...
  created() {
    this.columns1 = [
          ...
          return h('div', [
            h(
              'i-button',
              {
                ...
                directives: this.$common.bindAuth(562),
                style: {
                  color: '#265EA2'
                },
                on: {
            ...
            h(
              'i-button',
              {
                ...
                directives: this.$common.bindAuth(563),
                style: {
                  color: '#265EA2'
                },
                on: {
            ...
            h(
              'i-button',
              {
                ...
                directives: this.$common.bindAuth(564),
                style: {
                  color: '#265EA2'
                },
                on: {
            ...
            h(
              'i-button',
              {
                ...
                directives: this.$common.bindAuth(565),
                style: {
                  color: '#265EA2'
                },
                on: {
            ...
            h(
              'i-button',
              {
                ...
                directives: this.$common.bindAuth(566),
                style: {
                  color: '#265EA2'
                },
                on: {
      ...
      },
      {
        ...
        render: (h, { row, columns, index }) => h('span', {}, this.$filter.dateTimeFormat(row.operatorTime, 'YYYY-MM-DD HH:mm:ss'))
      }
    ]
  }
