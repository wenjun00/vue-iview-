...
export class FinanceDetainService {
   ...
   * 入库记录列表
   */
  getFinanceStorageEnterList(queryParamsModel: any, page: PageService): any {
    return this.netService.send({
      server: manageService.financeDetainController.getFinanceStorageEnterList,
      data: {
   ...
   * 出库记录列表
   */
  getFinanceStorageExportList(queryParamsModel: any, page: PageService): any {
    return this.netService.send({
      server: manageService.financeDetainController.getFinanceStorageExportList,
      data: {
        orderNo: queryParamsModel.orderNo,
        customerName: queryParamsModel.customerName,
        mortgageStatus: queryParamsModel.mortgageStatus
