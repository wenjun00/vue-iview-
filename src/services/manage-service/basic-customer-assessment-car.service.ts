...
export class BasicCustomerAssessmentCarService {
   ...
   * 获取评估报告文件
   */
  findAssessmentReportFile(stockId){
    return this.netService.send({
      server: manageService.basicCustomerAssessmentCarController.findAssessmentReportFile,
